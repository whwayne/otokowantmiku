...
*/
DWORD WINAPI
Thread::ThreadProc(LPVOID self)
{
     Thread* threadObj = (Thread*) self;
   // Thread::SetMyThreadName(threadObj->GetName().c_str());
...
*/
// void
// Thread::SetMyThreadName(const char* n)
// {
